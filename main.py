...
# file_path = 'C:\\Users\\admin\\PycharmProjects\\Handovers\\BSLUGLTE-3G.csv'
file_path = 'C:\\Users\\admin\\PycharmProjects\\Handovers\\138-2g-4g.csv'

ho = MakeHO(file_path)

ho.make_4g_ericsson_2g(pool)
# ho.make_3g_lte_ericsson(cells_3g)
